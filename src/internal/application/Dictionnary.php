 ...
 * @author poluxGit
 */
use polux\CorePHP\Internal\Exceptions\DictionnaryException as DicoException;
use polux\CorePHP\Managers\FileSystemManager as FSManager;
use polux\CorePHP\Internal\Exceptions\DictionnaryException;
...
class Dictionnary
{
     ...
     * 
     * @access protected
     * @throws DictionnaryException   If file to load doesn't exists!
     * @throws DictionnaryException   If json file can't be loaded!
     * 
