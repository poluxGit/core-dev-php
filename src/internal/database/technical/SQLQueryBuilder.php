 ...
 */
// use polux\CorePHP\Internal\Application\ApplicationException as AppException;
//use polux\CorePHP\Internal\Database\Technical\DbQuery as CoreDBQuery;
use polux\CorePHP\Internal\Database\Generic\SimpleGenericDBObject;
...
class SQLQueryBuilder {
     ...
     *
     * @param SimpleGenericDBObject $oCore Objet à mettre à jour en base de données.
