...
/**
 * Librairie prinicpale des opérations sur le système de fichiers
 * 
 * @author poluxGit
 */

namespace polux\CorePHP\FileSystem;
 ...
 *
 */
class FileSystem  // extends AnotherClass implements Interface
{
    // ------------------------- STATIC ATTRIBUTES ------------------------------
    /**
     ...
     *
     * @static
     * @throws FileSystemException    En cas d'erreur lors de la copie de fichier.
     *
    ...
    public static function copyFileToFile($inFilepath,$outFilePath)
    {
        ...
        if(!self::checkFileExistance($inFilepath))
        {
            ...
            throw new FileSystemException('CORE-FS_FILECOPY-SOURCE_FILE_NOT_FOUNDED',$lArrExceptionParam);
        }
        ...
        if(self::checkFileExistance($outFilePath))
        {
            ...
            throw new FileSystemException('CORE-FS_FILECOPY-DESTINATION_FILE_ALREADY_EXISTS',$lArrExceptionParam);
        }
    ...
    public static function copyFileToDirectory($inFilepath, $outDirectoryPath, $mode="CREATE")
    {
        ...
        if(!self::checkFileExistance($inFilepath))
        {
            ...
            throw new FileSystemException('CORE-FS_FILECOPY-SOURCEFILE_NOT_FOUNDED',$lArrExceptionParam);
        }
    ...
    public static function cleanDirectory($pathToClean)
    {
